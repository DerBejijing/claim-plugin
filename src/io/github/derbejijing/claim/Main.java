...
import io.github.derbejijing.claim.command.TeamInviteAccept;
import io.github.derbejijing.claim.command.TeamInviteDecline;
...
public class Main extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        this.getCommand("teaminviteaccept").setExecutor(new TeamInviteAccept());
        this.getCommand("teaminvitedecline").setExecutor(new TeamInviteDecline());
