...
public class TeamMember {
    ...
    public TeamMember(String name, String leader, String permission_invite, String permission_promote, String permission_kick, String permission_claim) {
        this.name = name;
    ...
    public String getString() {
        return "MEMBER " + name + " " + leader + " " + permission_invite + " " + permission_promote + " " + permission_kick + " " + permission_claim;
    }
